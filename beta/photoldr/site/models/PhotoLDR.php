<?php
/**
 * articlelayout Model for articlelayout World Component
 * 
 ...
 * @subpackage Components
 */
class articlelayoutModelarticlelayout extends JModel
{
	/**
	 * Gets the greeting
	...
	function getgreeting()
	{
		...
		$query = 'SELECT title,article_id FROM #__articlelayout';
		$db->setQuery( $query );
